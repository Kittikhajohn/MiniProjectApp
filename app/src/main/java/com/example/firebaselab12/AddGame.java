...
public class AddGame extends AppCompatActivity {
    ...
    //
    String Storage_Path = "Game_images/";
    String Database_Path = "Game";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new android.app.ProgressDialog(AddGame.this);
    ...
    */
    public void uploadFile() {
        ...
        if (filePath != null) {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            sRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri downloadPhotoUrl) {
                                    Game game = new Game(edName.getText().toString().trim(),
                                            Integer.parseInt(edPrice.getText().toString().trim()),
                                            downloadPhotoUrl.toString());

                                    //adding an upload to firebase database
                                    String uploadId = mDatabase.push().getKey();
                                    mDatabase.child(uploadId).setValue(game);
                                }
                            });
            ...
            android.widget.Toast.makeText(AddGame.this, "Please Select Image or Add Image Name", android.widget.Toast.LENGTH_LONG).show();
        }
    }
}